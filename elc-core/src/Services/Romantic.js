...
const Romantic = (props) => {
  ...
  return (
    ...
    <CardTitle style={{fontSize: '18px', fontWeight: '500'}}>Romantic Preparation</CardTitle>
    {button}
    <Collapse isOpen={isOpen}>
    <CardText style={{paddingTop: '10px'}}>Establishing and navigating meaningful close relationships has a direct correlation to happiness and self worth. We work one on one or with couples to develop healthy communication and mutual respect. </CardText>
    {/* <ListGroup>
