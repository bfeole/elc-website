...
const Social = (props) => {
  ...
  return (
    ...
    <CardTitle style={{fontSize: '18px', fontWeight: '500'}}>Social & Interpersonal Skills</CardTitle>
    {/* <hr></hr> */}
    {button}
    <Collapse isOpen={isOpen}>
      <CardText style={{paddingTop: '10px'}}>Social skills and social awareness are two of the most important and arguably the most difficult skills for teens and young adults. Establishing positive social behaviors and a sense of awareness builds self worth through guiding healthy relationships with peers.</CardText>
    {/* <ListGroup>
